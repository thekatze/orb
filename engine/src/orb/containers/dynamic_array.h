...
ORB_API void _orb_dynamic_array_push(orb_dynamic_array *array, const void *value_ptr);
...
ORB_API void orb_dynamic_array_remove_at(orb_dynamic_array *array, usize index, void *destination);
